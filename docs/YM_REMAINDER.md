Yang–Mills remainder checklist (operational)

1. Continuum entry ticket
- Provide (or cite) a single construction pathway with OS positivity, gauge invariance, Hamiltonian existence, cutoff removal.
- Output artifact: docs/CONTINUUM_CONSTRUCTION.md
